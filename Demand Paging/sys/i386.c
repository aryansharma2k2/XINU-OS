...
*/
	/* Physical heap and stacks should only use pages 0-1023 (4MB) */
	/* Pages 1024-2047 are frames, 2048-4095 are backing stores */
	maxaddr = (char *)( 1024 * NBPG - 1); /* 4M size - end of physical heap */
				 	      /* Frames (1024-2047) and backing stores (2048-4095) are excluded */
